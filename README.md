...
[![Build, test, and audit](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml/badge.svg?branch=master-26.3)](https://github.com/MinecraftModDevelopmentMods/OreSpawn/actions/workflows/ci.yml?query=branch%3Amaster-26.3)
...
This branch builds target-qualified version `4.0.16.2603001`: the OreSpawn 4.0.16
feature set for Minecraft 26.3 and Forge. See the
...
Minecraft 26.3; the build rejects a different Java 25 toolchain:
...
ForgeGradle 7.0.34, the Gradle 9.7.1 wrapper, Forge 66.0.0, official Minecraft
26.3 mappings, data-pack format 121.0, and resource-pack format 97.1. Ordinary
Eclipse launches exclude tests and fixtures. Published jars are deterministic and retain Forge 66's official
runtime names, are audited for their three access-transformer rules and contents, and
